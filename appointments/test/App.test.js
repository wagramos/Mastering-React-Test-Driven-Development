...
import { createShallowRenderer, type, className, childrenOf, click, id } from './shallowHelpers';
...
describe('App', () => {
  ...
  it('hides the AppointmentdatViewLoader when button is clicked', async () => {
    beginAddingCustomerAndAppointment();
  ...
  it('render AppointmentDayViewLoader after AppointmentFrom is submitted', async () => {
    beginAddingCustomerAndAppointment();
    saveCustomer();
    saveAppointment();
